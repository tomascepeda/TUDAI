...
//		e) recuperar todos los estudiantes, en base a su género.
		// Se seleccionan todos los estudiantes y se los filtra por un género pasado por
		// parámetro
		@NamedQuery(name = Estudiante.BUSCAR_POR_GENERO, query = "SELECT e FROM Estudiante e WHERE e.genero = :generoPass"),
//		d) recuperar un estudiante, en base a su número de libreta universitaria.
		// Se seleccionan todos los estudiantes en base a un número de libreta pasado
		// por parámetro
