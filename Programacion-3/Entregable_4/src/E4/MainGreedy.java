...
public class MainGreedy {
	...
	public static void main(String[] args) {
		...
		System.out.println(greedy.armarGrupos(entrada1));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());

		System.out.println();
		System.out.println("entrada 2");
		System.out.println(greedy.armarGrupos(entrada2));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());

		System.out.println();
		System.out.println("entrada 3");
		System.out.println(greedy.armarGrupos(entrada3));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());

		System.out.println();
		System.out.println("entrada 4");
		System.out.println(greedy.armarGrupos(entrada4));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());

		System.out.println();
		System.out.println("entrada 5");
		System.out.println(greedy.armarGrupos(entrada5));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());

		System.out.println();
		System.out.println("entrada 6");
		System.out.println(greedy.armarGrupos(entrada6));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());

		System.out.println();
		System.out.println("entrada 7");
		System.out.println(greedy.armarGrupos(entrada7));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());

		System.out.println();
		System.out.println("entrada 8");
		System.out.println(greedy.armarGrupos(entrada8));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());

		System.out.println();
		System.out.println("entrada 9");
		System.out.println(greedy.armarGrupos(entrada9));
		System.out.println("Cantidad de candidatos seleccionados: " + greedy.getCantCandidatos());
