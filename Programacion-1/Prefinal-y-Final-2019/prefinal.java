...
public class prefinal { //se pide invertir CANT de secuencias de todas las filas de la matriz comenzando del final 
	...
	public static void buscar_secuencias(int [][] mat, int f, int cant) {
		int i=ncol-1;
		int inicio=-1;
		int fin=-1;
		while(cant>0&&i>0) {
